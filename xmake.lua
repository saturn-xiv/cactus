...
add_requires("argparse", "toml++", "spdlog", "cpp-httplib", "cppcodec", "stduuid", "openssl", "cpr", "nlohmann_json")
...
target("cactus")
    ...
    add_packages("argparse", "toml++", "spdlog", "cpp-httplib", "cppcodec", "stduuid", "openssl", "cpr", "nlohmann_json")
